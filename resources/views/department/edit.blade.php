...
@section('content')
            ...
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header">{{ __('Update Country') }}  
                        <a href="{{ route('department.index') }}" class="float-right">Back</a>
                    </div>
  ...
  <form action="{{ route('department.destroy', $department->id) }}" method="post" class='mb-2 mt-2 p-2 float-lg-right'>
        @csrf
        @method('DELETE')
